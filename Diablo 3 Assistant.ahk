...
Gui, Tab, Cube
Gui, Add, Text, x0 y+0 w168 Center vCubePageName, Upgrade Rare Item ;Dynamic name in cube also used for Rare rarities can be used in the conversion process
...
Transmute:			;Handle Gui Transmute button
	...
	If  (Pages = "Page 3")
		Loop {	
			PixelSearch, RareLeft, RareRight, %TopLeftX%, %TopLeftY%, %BottomRightX%, %BottomRightY%, 0x083B4A, 3 , Fast
			If ErrorLevel
						Break
...
UpgradeRareItem:			;Handles CubeUpgrade Rare Items
	...
	GuiControl,, CubePageName, Upgrade Rare Item
...
ConvertGems:			;Handles CubeConvert Gems
	...
	GuiControl,, CubePageName, Convert Gems
	GuiControl,, RepeatTime, How many items in inventory?`nHow many times to repeat?`nUp to 60 Slots
...
ConvertReusableParts:			;Handles Cube Convert Reusable Parts
	...
	GuiControl,, Rarity, Rare item(s) in inventory
	GuiControl,, CubePageName, Convert Reusable Parts
	GuiControl,, RepeatTime, How many items in inventory?`nHow many times to repeat?`nUp to 60 Slots
	GuiControl, Move, Rarity, y62
...
ConvertArcaneDust:			;Handles Cube Convert Arcane Dust
	...
	GuiControl,, CubePageName, Convert Arcane Dust
	GuiControl,, RepeatTime, How many items in inventory?`nHow many times to repeat?`nUp to 60 Slots
...
ConvertVeiledCrystal:			;Handles Cube Convert Veiled Crystals
	...
	GuiControl,, CubePageName, Convert Veiled Crystals
	GuiControl,, RepeatTime, How many items in inventory?`nHow many times to repeat?`nUp to 60 Slots
